...
**Response**:That certain species tend to fall in different ranges of flipper length.
Box plot atleast as the color coordination, while the jitterplot allows us to see the individual points.
